!(function (a, b) {
      ...
      if (h) {
        ...
        for (c in h)
          for (d = 0, e = h[c].length; d < e; d++)
            K.event.add(
              b,
              c + (h[c][d].namespace ? "." : "") + h[c][d].namespace,
              h[c][d],
              h[c][d].data
            );
      }
  ...
  function q(a) {
    ...
    "input" === b
      ...
      : "script" !== b &&
        ...
        K.grep(a.getElementsByTagName("input"), p);
  }
  function r(a) {
  ...
  function s(a, b) {
    b.src
      ...
      : K.globalEval(
          (b.text || b.textContent || b.innerHTML || "").replace(Ba, "/*$0*/")
        ),
      ...
      if ("border" !== c)
        for (; f < g; f++)
          c || (d -= parseFloat(K.css(a, "padding" + e[f])) || 0),
            "margin" === c
              ? (d += parseFloat(K.css(a, c + e[f])) || 0)
              : (d -= parseFloat(K.css(a, "border" + e[f] + "Width")) || 0);
      return d + "px";
    }
    if (
      ((d = Ea(a, b, b)),
      (d < 0 || null == d) && (d = a.style[b] || 0),
      (d = parseFloat(d) || 0),
      c)
    )
      for (; f < g; f++)
  ...
  function u(a) {
    return function (b, c) {
      if (("string" != typeof b && ((c = b), (b = "*")), K.isFunction(c)))
        for (
          var d, e, f, g = b.toLowerCase().split(cb), h = 0, i = g.length;
          h < i;
          h++
        )
          (d = g[h]),
  ...
  function v(a, c, d, e, f, g) {
    ...
    for (
      var h, i = a[f], j = 0, k = i ? i.length : 0, l = a === gb;
      j < k && (l || !h);
      j++
    )
      "string" == typeof (h = i[j](c, d, e)) &&
        (!l || g[h]
          ? (h = b)
          : (c.dataTypes.unshift(h), (h = v(a, c, d, e, h, g))));
    ...
    if (K.isArray(b))
      K.each(b, function (b, e) {
        c || Ta.test(a)
          ? d(a, e)
          : x(
              a + "[" + ("object" == typeof e || K.isArray(e) ? b : "") + "]",
              e,
              c,
              d
            );
  ...
  function E(a, b) {
    var c = {};
    return (
      K.each(vb.concat.apply([], vb.slice(0, b)), function () {
        c[this] = a;
      }),
      c
    );
  ...
  function F(a) {
    if (!sb[a]) {
      ...
      c.remove(),
        ("none" !== d && "" !== d) ||
          (ob ||
            ((ob = H.createElement("iframe")),
            (ob.frameBorder = ob.width = ob.height = 0)),
          b.appendChild(ob),
          (pb && ob.createElement) ||
            ((pb = (ob.contentWindow || ob.contentDocument).document),
            pb.write(
              ("CSS1Compat" === H.compatMode ? "<!doctype html>" : "") +
                "<html><body>"
            ),
            pb.close()),
      ...
      return (
        (h.fn = h.prototype =
          {
                    ...
                    g
                      ? h.isPlainObject(c)
                        ? ((a = [H.createElement(g[1])]),
                          h.fn.attr.call(a, c, !0))
                        : (a = [i.createElement(g[1])])
                      : ((g = h.buildFragment([e[1]], [i])),
                        (a = (g.cacheable ? h.clone(g.fragment) : g.fragment)
                          .childNodes)),
                    h.merge(this, a)
                  );
            ...
            pushStack: function (a, b, c) {
              ...
              return (
                h.isArray(a) ? D.apply(d, a) : h.merge(d, a),
                (d.prevObject = this),
                  ...
                  (d = i[c]),
                    ...
                    i !== e &&
                      (l && e && (h.isPlainObject(e) || (f = h.isArray(e)))
                        ? (f
                            ? ((f = !1), (g = d && h.isArray(d) ? d : []))
                            : (g = d && h.isPlainObject(d) ? d : {}),
                          (i[c] = h.extend(l, g, e)))
                        : e !== b && (i[c] = e));
            return i;
          }),
        h.extend({
          noConflict: function (b) {
            return (
              a.$ === h && (a.$ = j), b && a.jQuery === h && (a.jQuery = i), h
            );
          },
          isReady: !1,
          readyWait: 1,
          ...
          bindReady: function () {
            if (!f) {
              if (
                ((f = h.Callbacks("once memory")), "complete" === H.readyState)
              )
          ...
          parseJSON: function (b) {
            return "string" == typeof b && b
              ? ((b = h.trim(b)),
                a.JSON && a.JSON.parse
                  ? a.JSON.parse(b)
                  : p.test(b.replace(q, "@").replace(r, "]").replace(s, ""))
                  ? new Function("return " + b)()
                  : void h.error("Invalid JSON: " + b))
              : null;
          },
          parseXML: function (c) {
            var d, e;
          ...
          trim: F
            ...
            : function (a) {
                return null == a
                  ? ""
                  : a.toString().replace(m, "").replace(n, "");
              },
          ...
          uaMatch: function (a) {
            ...
            var b =
              ...
              u.exec(a) ||
              v.exec(a) ||
              (a.indexOf("compatible") < 0 && w.exec(a)) ||
              [];
          ...
          sub: function () {
            ...
            h.extend(!0, a, this),
              ...
              (a.fn.init = function (c, d) {
                return (
                  d && d instanceof h && !(d instanceof a) && (d = a(d)),
        ...
        (e = h.uaMatch(A)),
        e.browser &&
          ((h.browser[e.browser] = !0), (h.browser.version = e.version)),
          ...
          : H.attachEvent &&
            (g = function () {
              "complete" === H.readyState &&
                (H.detachEvent("onreadystatechange", g), h.ready());
            }),
        h
      );
    })(),
      ...
      k = function (b) {
        ...
        for (c = 0, d = b.length; c < d; c++)
          (e = b[c]),
            ...
            "array" === f
              ? k(e)
              : "function" === f && ((a.unique && m.has(e)) || i.push(e));
      },
      l = function (b, c) {
        for (
          c = c || [],
          ...
          i &&
            (a.once
              ? !0 === d
                ? m.disable()
                : (i = [])
              : j && j.length && ((d = j.shift()), m.fireWith(d[0], d[1])));
      },
      m = {
        add: function () {
          if (i) {
            var a = i.length;
            k(arguments),
              e ? (g = i.length) : d && !0 !== d && ((f = a), l(d[0], d[1]));
          }
          return this;
        },
        remove: function () {
        ...
        has: function (a) {
          if (i)
            for (var b = 0, c = i.length; b < c; b++) if (a === i[b]) return !0;
          return !1;
        },
        empty: function () {
          return (i = []), this;
        ...
        fireWith: function (b, c) {
          return (
            j && (e ? a.once || j.push([b, c]) : (a.once && d) || l(b, c)), this
          );
        },
        fire: function () {
  ...
  K.extend({
                  ...
                  K.isFunction(e)
                    ? i[a](function () {
                        (c = e.apply(this, arguments)),
                          c && K.isFunction(c.promise)
                            ? c.promise().then(d.resolve, d.reject, d.notify)
                            : d[f + "With"](this === i ? d : this, [c]);
                      })
                    : i[a](d[f]);
                }
              );
    ...
    when: function (a) {
      ...
      if (f > 1) {
        for (; e < f; e++)
          d[e] && d[e].promise && K.isFunction(d[e].promise)
            ? d[e].promise().then(b(e), i.reject, c(e))
            : --h;
        h || i.resolveWith(i, d);
      ...
      if (
        ...
        a.getComputedStyle &&
          ...
          (b.reliableMarginRight =
            0 ===
            (parseInt(
              (a.getComputedStyle(h, null) || { marginRight: 0 }).marginRight,
              10
            ) || 0))),
        n.attachEvent)
      )
        for (l in { submit: 1, change: 1, focusin: 1 })
          (k = "on" + l),
            (m = k in n),
            m ||
              (n.setAttribute(k, "return;"), (m = "function" == typeof n[k])),
            (b[l + "Bubbles"] = m);
      return (
        i.removeChild(n),
        (i = e = f = h = n = g = null),
  ...
  K.extend({
        ...
        if ((m && l[m] && (n || e || l[m].data)) || !j || d !== b)
          return (
            ...
            ("object" != typeof c && "function" != typeof c) ||
              (e
                ? (l[m] = K.extend(l[m], c))
                : (l[m].data = K.extend(l[m].data, c))),
            (f = g = l[m]),
            e || (g.data || (g.data = {}), (g = g.data)),
            d !== b && (g[K.camelCase(c)] = d),
            n && !g[c]
              ? f.events
              : (j ? null == (h = g[c]) && (h = g[K.camelCase(c)]) : (h = g), h)
          );
      }
    },
        ...
        if (j[k]) {
          if (b && (d = c ? j[k] : j[k].data)) {
            K.isArray(b) ||
              (b in d
                ? (b = [b])
                : ((b = K.camelCase(b)), (b = b in d ? [b] : b.split(" "))));
            for (f = 0, g = b.length; f < g; f++) delete d[b[f]];
            if (!(c ? e : K.isEmptyObject)(d)) return;
          }
          (c || (delete j[k].data, e(j[k]))) &&
            (K.support.deleteExpando || !j.setInterval
              ? delete j[k]
              : (j[k] = null),
            i &&
        ...
        if (void 0 === a) {
          if (
            ...
            for (var i = 0, j = f.length; i < j; i++)
              (g = f[i].name),
                0 === g.indexOf("data-") &&
                  ((g = K.camelCase(g.substring(5))), d(this[0], g, h[g]));
          ...
          : ((e = a.split(".")),
            ...
            c === b
              ? ((h = this.triggerHandler("getData" + e[1] + "!", [e[0]])),
                h === b &&
                  this.length &&
                  ((h = K.data(this[0], a)), (h = d(this[0], a, h))),
                h === b && e[1] ? this.data(e[0]) : h)
              : this.each(function () {
                  var b = K(this),
                    d = [e[0], c];
    ...
    K.extend({
      _mark: function (a, b) {
        a &&
          ((b = (b || "fx") + "mark"), K._data(a, b, (K._data(a, b) || 0) + 1));
      },
      ...
      dequeue: function (a, b) {
        ...
        "inprogress" === d && (d = c.shift()),
          ...
          c.length ||
            (K.removeData(a, b + "queue " + b + ".run", !0), f(a, b, "queue"));
      },
    }),
    K.fn.extend({
      queue: function (a, c) {
      ...
      promise: function (a, c) {
        ...
        for (
          ...
          (e =
            K.data(g[h], j, b, !0) ||
            ((K.data(g[h], k, b, !0) || K.data(g[h], l, b, !0)) &&
              K.data(g[h], j, K.Callbacks("once memory"), !0))) &&
            (i++, e.add(d));
        return d(), f.promise();
      },
    });
  ...
  K.fn.extend({
    ...
    toggleClass: function (a, b) {
      ...
      return K.isFunction(a)
        ...
        : this.each(function () {
            if ("string" === c)
              for (
                var e, f = 0, g = K(this), h = b, i = a.split(T);
                (e = i[f++]);
    ...
    hasClass: function (a) {
      for (var b = " " + a + " ", c = 0, d = this.length; c < d; c++)
        if (
          1 === this[c].nodeType &&
          (" " + this[c].className + " ").replace(S, " ").indexOf(b) > -1
        )
          return !0;
      return !1;
    },
            ...
            this.each(function (d) {
              ...
              1 === this.nodeType &&
                ...
                ((c =
                  ...
                  "set" in c &&
                  c.set(this, f, "value") !== b) ||
                  (this.value = f));
            })
          );
        if (f)
          return (c =
            K.valHooks[f.nodeName.toLowerCase()] || K.valHooks[f.type]) &&
            "get" in c &&
            (d = c.get(f, "value")) !== b
            ? d
            : ((d = f.value),
              "string" == typeof d ? d.replace(U, "") : null == d ? "" : d);
      }
    },
  }),
    K.extend({
              ...
              if (
                ...
                e.selected &&
                  ...
                  (!e.parentNode.disabled ||
                    !K.nodeName(e.parentNode, "optgroup")))
              ) {
      ...
      removeAttr: function (a, b) {
        var c,
          ...
          g = 0;
        if (b && 1 === a.nodeType)
          for (d = b.toLowerCase().split(T), f = d.length; g < f; g++)
            (e = d[g]) &&
              ((c = K.propFix[e] || e),
              K.attr(a, e, ""),
        ...
        tabIndex: {
          get: function (a) {
            ...
            return c && c.specified
              ? parseInt(c.value, 10)
              : W.test(a.nodeName) || (X.test(a.nodeName) && a.href)
              ? 0
              : b;
          },
        },
      ...
      (P = K.valHooks.button =
        {
          ...
          set: function (a, b, c) {
            ...
            return (
              d || ((d = H.createAttribute(c)), a.setAttributeNode(d)),
              (d.nodeValue = b + "")
            );
          },
        }),
  ...
  var $ = /^(?:textarea|input|select)$/i,
    ...
    ha = function (a) {
      return K.event.special.hover
        ? a
        : a.replace(aa, "mouseenter$1 mouseleave$1");
    };
  (K.event = {
        ...
        for (
          d.handler && ((o = d), (d = o.handler)),
            ...
            h ||
              ((g.handle = h =
                function (a) {
                  return void 0 === K || (a && K.event.triggered === a.type)
                    ? b
                    : K.event.dispatch.apply(h.elem, arguments);
                }),
              (h.elem = a)),
            c = K.trim(ha(c)).split(" "),
            j = 0;
          ...
          (k = _.exec(c[j]) || []),
            ...
            p ||
              ((p = i[l] = []),
              (p.delegateCount = 0),
              (q.setup && !1 !== q.setup.call(a, e, m, h)) ||
                (a.addEventListener
      ...
      if (r && (m = r.events)) {
        for (b = K.trim(ha(b || "")).split(" "), f = 0; f < b.length; f++)
          if (((g = _.exec(b[f]) || []), (h = i = g[1]), (j = g[2]), h)) {
            ...
            0 === p.length &&
              k !== p.length &&
              ((n.teardown && !1 !== n.teardown.call(a, j)) ||
                K.removeEvent(a, h, r.handle),
              delete m[h]);
        ...
        if (
          ...
          if (
            ...
            if (
              ...
              return (
                ...
                f ||
                  ...
                  ("click" === q && K.nodeName(e, "a")) ||
                  !K.acceptData(e) ||
                  (l &&
                    e[q] &&
                    (("focus" !== q && "blur" !== q) ||
                      0 !== c.target.offsetWidth) &&
                    !K.isWindow(e) &&
                    ((k = e[l]),
                    k && (e[l] = null),
                    (K.event.triggered = q),
            ...
            for (i in g)
              g[i].events &&
                g[i].events[q] &&
                K.event.trigger(c, d, g[i].handle.elem, !0);
          }
      }
    },
    dispatch: function (c) {
      ...
      if (
        ...
        for (
          g = K(this), g.context = this.ownerDocument || this, f = c.target;
          f != this;
          f = f.parentNode || this
        ) {
      ...
      for (
        n.length > o && r.push({ elem: this, matches: n.slice(o) }), d = 0;
        d < r.length && !c.isPropagationStopped();
        d++
      )
        for (
          j = r[d], c.currentTarget = j.elem, e = 0;
          ...
          (l = j.matches[e]),
            (q ||
              ...
              (c.handleObj = l),
              (h = (
                (K.event.special[l.origType] || {}).handle || l.handler
              ).apply(j.elem, p)) !== b &&
                ((c.result = h),
                !1 === h && (c.preventDefault(), c.stopPropagation())));
      return c.result;
    },
    props:
    ...
    fix: function (a) {
      ...
      return (
        a.target || (a.target = e.srcElement || H),
      ...
      (K.event.special.submit = {
        setup: function () {
          ...
          K.event.add(this, "click._submit keypress._submit", function (a) {
            var c = a.target,
              d =
                K.nodeName(c, "input") || K.nodeName(c, "button") ? c.form : b;
            d &&
              !d._submit_attached &&
              (K.event.add(d, "submit._submit", function (a) {
                this.parentNode &&
                  !a.isTrigger &&
                  K.event.simulate("submit", this.parentNode, a, !0);
              }),
      ...
      (K.event.special.change = {
        setup: function () {
          ...
          K.event.add(this, "beforeactivate._change", function (a) {
            ...
            $.test(b.nodeName) &&
              !b._change_attached &&
              (K.event.add(b, "change._change", function (a) {
                !this.parentNode ||
                  a.isSimulated ||
                  a.isTrigger ||
                  K.event.simulate("change", this.parentNode, a, !0);
              }),
      ...
      toggle: function (a) {
        var b = arguments,
          ...
          e = function (c) {
            ...
            return (
              K._data(this, "lastToggle" + a.guid, e + 1),
              c.preventDefault(),
    ...
    (function () {
        ...
        for (var h = 0, i = d.length; h < i; h++) {
          ...
          if (j) {
            ...
            for (j = j[a]; j; ) {
              ...
              if (
                (1 !== j.nodeType || g || ((j[e] = c), (j.sizset = h)),
      ...
      var m = function (a, b, c, e) {
        ...
        do {
          if (
            (d.exec(""), (h = d.exec(x)) && ((x = h[3]), w.push(h[1]), h[2]))
          ) {
            k = h[3];
            break;
          }
        ...
        if (
          (j || (j = i), j || m.error(n || a), "[object Array]" === g.call(j))
        )
          if (t)
            if (b && 1 === b.nodeType)
              for (r = 0; null != j[r]; r++)
                j[r] &&
                  (!0 === j[r] ||
                    (1 === j[r].nodeType && m.contains(b, j[r]))) &&
                  c.push(i[r]);
            else
              for (r = 0; null != j[r]; r++)
            ...
            CHILD: function (a, b) {
              ...
              switch (j) {
                ...
                case "nth":
                  ...
                  if (
                    ((f = b[0]),
                    (g = a.parentNode) && (g[e] !== f || !a.nodeIndex))
                  ) {
              ...
              m = function (b, c, d, e) {
                if (((c = c || H), !e && !m.isXML(c))) {
                  ...
                  if (f && (1 === c.nodeType || 9 === c.nodeType)) {
                    ...
                    if (f[2] && o.find.CLASS && c.getElementsByClassName)
  ...
  K.fn.extend({
    ...
    is: function (a) {
      return (
        ...
        ("string" == typeof a
          ? na.test(a)
            ? K(a, this.context).index(this[0]) >= 0
            : K.filter(a, this).length > 0
    ...
    closest: function (a, b) {
      ...
      if (K.isArray(a)) {
        for (var g = 1; f && f.ownerDocument && f !== b; ) {
          for (c = 0; c < a.length; c++)
            K(f).is(a[c]) && e.push({ selector: a[c], elem: f, level: g });
          (f = f.parentNode), g++;
        }
        return e;
      }
      ...
      return (
        (e = e.length > 1 ? K.unique(e) : e), this.pushStack(e, "closest", a)
      );
    },
    index: function (a) {
      return a
    ...
    K.fn.extend({
      text: function (a) {
        return K.isFunction(a)
          ...
          : "object" != typeof a && a !== b
          ? this.empty().append(
              ((this[0] && this[0].ownerDocument) || H).createTextNode(a)
            )
          : K.text(this);
      },
      wrapAll: function (a) {
      ...
      remove: function (a, b) {
        for (var c, d = 0; null != (c = this[d]); d++)
          (a && !K.filter(a, [c]).length) ||
            (b ||
              1 !== c.nodeType ||
              (K.cleanData(c.getElementsByTagName("*")), K.cleanData([c])),
      ...
      empty: function () {
        for (var a, b = 0; null != (a = this[b]); b++)
          for (
            1 === a.nodeType && K.cleanData(a.getElementsByTagName("*"));
            a.firstChild;
      ...
      html: function (a) {
        if (a === b)
          return this[0] && 1 === this[0].nodeType
            ? this[0].innerHTML.replace(qa, "")
            : null;
        if (
          "string" != typeof a ||
          wa.test(a) ||
          (!K.support.leadingWhitespace && ra.test(a)) ||
          Ca[(ta.exec(a) || ["", ""])[1].toLowerCase()]
        )
          K.isFunction(a)
            ? this.each(function (b) {
                var c = K(this);
          ...
          try {
            for (var c = 0, d = this.length; c < d; c++)
              1 === this[c].nodeType &&
                (K.cleanData(this[c].getElementsByTagName("*")),
                (this[c].innerHTML = a));
          } catch (b) {
            this.empty().append(a);
          }
      ...
      domManip: function (a, c, d) {
        ...
        if (this[0]) {
          if (
            ...
            c = c && K.nodeName(f, "tr");
            for (var k = 0, m = this.length, n = m - 1; k < m; k++)
              d.call(
                c ? l(this[k], f) : this[k],
                e.cacheable || (m > 1 && k < n) ? K.clone(g, !0, !0) : g
              );
          }
          j.length && K.each(j, s);
        }
    ...
    (K.buildFragment = function (a, b, c) {
      ...
      return (
        ...
        !(
          ...
          xa.test(h) ||
          (!K.support.checkClone && za.test(h)) ||
          (!K.support.html5Clone && ya.test(h)) ||
          ((e = !0), (f = K.fragments[h]) && 1 !== f && (d = f)),
    ...
    K.extend({
      clone: function (a, b, c) {
        var d,
          ...
          f,
          g =
            K.support.html5Clone || !ya.test("<" + a.nodeName)
              ? a.cloneNode(!0)
              : r(a);
        if (
          !(
      ...
      clean: function (a, b, c, d) {
        var e;
        (b = b || H),
          void 0 === b.createElement &&
            (b = b.ownerDocument || (b[0] && b[0].ownerDocument) || H);
          ...
          if (("number" == typeof g && (g += ""), g)) {
            if ("string" == typeof g)
              if (va.test(g)) {
                ...
                for (
                  b === H ? Da.appendChild(n) : k(b).appendChild(n),
                    n.innerHTML = l[1] + g + l[2];
                  m--;
        ...
        if (c)
          for (
            ...
            if (
              !d ||
              !K.nodeName(h[i], "script") ||
              (h[i].type && "text/javascript" !== h[i].type.toLowerCase())
            ) {
              if (1 === h[i].nodeType) {
      ...
      cleanData: function (a) {
        for (
          ...
          if (
            (!d.nodeName || !K.noData[d.nodeName.toLowerCase()]) &&
            (c = d[K.expando])
          ) {
            if ((b = e[c]) && b.events) {
            ...
            g
              ? delete d[K.expando]
              : d.removeAttribute && d.removeAttribute(K.expando),
              delete e[c];
          }
      },
    });
  ...
  (K.fn.css = function (a, c) {
      ...
      style: function (a, c, d, e) {
        if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
          ...
          if (
            ...
            "string" === g &&
              (f = Ma.exec(d)) &&
              ((d = +(f[1] + 1) * +f[2] + parseFloat(K.css(a, c))),
              (g = "number")),
            null == d ||
              ("number" === g && isNaN(d)) ||
              ("number" !== g || K.cssNumber[h] || (d += "px"),
        ...
        set: function (a, b) {
          ...
          (c.zoom = 1),
            (b >= 1 &&
              ...
              (c.filter = Ha.test(f) ? f.replace(Ha, e) : f + " " + e);
        },
      }),
    K(function () {
    ...
    H.defaultView &&
      ...
      (Fa = function (a, b) {
        var c, d, e;
        return (
          (b = b.replace(Ja, "-$1").toLowerCase()),
          (d = a.ownerDocument.defaultView) &&
            (e = d.getComputedStyle(a, null)) &&
            ("" !== (c = e.getPropertyValue(b)) ||
              K.contains(a.ownerDocument.documentElement, a) ||
              (c = K.style(a, b))),
          c
        );
      }),
      ...
      ((K.expr.filters.hidden = function (a) {
        ...
        return (
          ...
          (!K.support.reliableHiddenOffsets &&
            "none" === ((a.style && a.style.display) || K.css(a, "display")))
        );
      }),
  ...
  (Ra = eb.exec(Qa.toLowerCase()) || []),
      ...
      load: function (a, c, d) {
        ...
        c &&
          (K.isFunction(c)
            ? ((d = c), (c = b))
            : "object" == typeof c &&
              ((c = K.param(c, K.ajaxSettings.traditional)), (g = "POST")));
        var h = this;
        return (
          K.ajax({
            url: a,
        ...
        return this.map(function () {
          ...
          .filter(function () {
            return (
              this.name &&
              !this.disabled &&
              (this.checked || bb.test(this.nodeName) || Xa.test(this.type))
            );
          })
          .map(function (a, b) {
            var c = K(this).val();
    ...
    K.extend({
      ...
      ajaxSetup: function (a, b) {
        return (
          b ? w(a, K.ajaxSettings) : ((b = a), (a = K.ajaxSettings)), w(a, b), a
        );
      },
      ajaxSettings: {
        url: Qa,
      ...
      ajax: function (a, c) {
        function d(a, c, d, g) {
          if (2 !== u) {
              ...
              if (
                (m.ifModified &&
                  ((t = w.getResponseHeader("Last-Modified")) &&
                    (K.lastModified[e] = t),
                  (v = w.getResponseHeader("Etag")) && (K.etag[e] = v)),
                304 === a)
              )
                (x = "notmodified"), (j = !0);
              else
            ...
            (w.status = a),
              ...
              (r = b),
              k &&
                o.trigger("ajax" + (j ? "Success" : "Error"), [
                  w,
                  m,
                  j ? l : s,
                ]),
        ...
        if (
          ...
          (m.url = ((a || m.url) + "")
            .replace(Va, "")
            .replace($a, Ra[1] + "//")),
          (m.dataTypes = K.trim(m.dataType || "*")
            .toLowerCase()
            .split(cb)),
          null == m.crossDomain &&
            ((j = eb.exec(m.url.toLowerCase())),
            (m.crossDomain = !(
              !j ||
              (j[1] == Ra[1] &&
                j[2] == Ra[2] &&
                (j[3] || ("http:" === j[1] ? 80 : 443)) ==
                  (Ra[3] || ("http:" === Ra[1] ? 80 : 443)))
            ))),
          m.data &&
            m.processData &&
        ...
        if (
          ...
          k && 0 == K.active++ && K.event.trigger("ajaxStart"),
          !m.hasContent &&
            (m.data &&
              ((m.url += (_a.test(m.url) ? "&" : "?") + m.data), delete m.data),
            (e = m.url),
            !1 === m.cache))
        ) {
          var x = K.now(),
        ...
        ((m.data && m.hasContent && !1 !== m.contentType) || c.contentType) &&
          ...
          m.ifModified &&
            ((e = e || m.url),
            K.lastModified[e] &&
              w.setRequestHeader("If-Modified-Since", K.lastModified[e]),
            K.etag[e] && w.setRequestHeader("If-None-Match", K.etag[e])),
          w.setRequestHeader(
            "Accept",
            m.dataTypes[0] && m.accepts[m.dataTypes[0]]
              ? m.accepts[m.dataTypes[0]] +
                  ("*" !== m.dataTypes[0] ? ", " + ib + "; q=0.01" : "")
              : m.accepts["*"]
          );
  ...
  K.ajaxSetup({
    ...
    K.ajaxPrefilter("json jsonp", function (b, c, d) {
      var e =
        "application/x-www-form-urlencoded" === b.contentType &&
        "string" == typeof b.data;
      if (
        "jsonp" === b.dataTypes[0] ||
        (!1 !== b.jsonp && (kb.test(b.url) || (e && kb.test(b.data))))
      ) {
        var f,
          g = (b.jsonpCallback = K.isFunction(b.jsonpCallback)
            ? b.jsonpCallback()
            : b.jsonpCallback),
          h = a[g],
          i = b.url,
                  ...
                  try {
                    if (d && (e || 4 === i.readyState))
                      if (
                        ((d = b),
                        g &&
                          ((i.onreadystatechange = K.noop), mb && delete lb[g]),
                        e)
                      )
    ...
    show: function (a, b, c) {
      ...
      for (var f = 0, g = this.length; f < g; f++)
        (d = this[f]),
          d.style &&
            ((e = d.style.display),
            K._data(d, "olddisplay") ||
              "none" !== e ||
              (e = d.style.display = ""),
            "" === e &&
              "none" === K.css(d, "display") &&
              K._data(d, "olddisplay", F(d.nodeName)));
      for (f = 0; f < g; f++)
        (d = this[f]),
          d.style &&
            (("" !== (e = d.style.display) && "none" !== e) ||
              (d.style.display = K._data(d, "olddisplay") || ""));
      return this;
    },
    hide: function (a, b, c) {
      if (a || 0 === a) return this.animate(E("hide", 3), a, b, c);
      for (var d, e, f = 0, g = this.length; f < g; f++)
        (d = this[f]),
          d.style &&
            ("none" === (e = K.css(d, "display")) ||
              K._data(d, "olddisplay") ||
              K._data(d, "olddisplay", e));
    ...
    animate: function (a, b, c, d) {
      function e() {
        ...
        for (d in a) {
          if (
            ((b = K.camelCase(d)),
            d !== b && ((a[b] = a[d]), delete a[d]),
            (c = a[b]),
            K.isArray(c)
              ? ((l.animatedProperties[b] = c[1]), (c = a[b] = c[0]))
              : (l.animatedProperties[b] =
                  (l.specialEasing && l.specialEasing[b]) ||
                  l.easing ||
                  "swing"),
            ("hide" === c && n) || ("show" === c && !n))
          )
          ...
          !m ||
            ...
            "inline" === K.css(this, "display") &&
              ...
              (K.support.inlineBlockNeedsLayout && "inline" !== F(this.nodeName)
                ? (this.style.zoom = 1)
        ...
        for (d in a)
          (e = new K.fx(this, l, d)),
            ...
            tb.test(c)
              ? ((k =
                  K._data(this, "toggle" + d) ||
                  ("toggle" === c ? (n ? "show" : "hide") : 0)),
                k
                  ? (K._data(
                      this,
                      "toggle" + d,
              ...
              : ((g = ub.exec(c)),
                ...
                g
                  ? ((i = parseFloat(g[2])),
                    (j = g[3] || (K.cssNumber[d] ? "" : "px")),
                    "px" !== j &&
                      (K.style(this, d, (i || 1) + j),
                      (h = ((i || 1) / e.cur()) * h),
                      K.style(this, d, h + j)),
                    g[1] && (i = ("-=" === g[1] ? -1 : 1) * i + h),
                    e.custom(h, i, j))
      ...
      return K.isEmptyObject(a)
        ...
        : ((a = K.extend({}, a)),
          !1 === f.queue ? this.each(e) : this.queue(f.queue, e));
    },
    stop: function (a, c, d) {
      return (
      ...
      custom: function (a, c, d) {
        ...
        (this.startTime = rb || C()),
          ...
          (e.saveState = function () {
            f.options.hide &&
              K._data(f.elem, "fxshow" + f.prop) === b &&
              K._data(f.elem, "fxshow" + f.prop, f.start);
          }),
          e() &&
            K.timers.push(e) &&
            !qb &&
            (qb = setInterval(g.tick, g.interval));
      },
      show: function () {
      ...
      step: function (a) {
        ...
        if (a || e >= h.duration + this.startTime) {
          ...
          if (f) {
            if (
              ...
              for (b in h.animatedProperties)
                K.style(g, b, h.orig[b]),
                  K.removeData(g, "fxshow" + b, !0),
                  K.removeData(g, "toggle" + b, !0);
        ...
        return (
          h.duration == 1 / 0
            ? (this.now = e)
            : ((c = e - this.startTime),
              (this.state = c / h.duration),
              (this.pos = K.easing[h.animatedProperties[this.prop]](
                this.state,
                c,
                0,
                1,
  ...
  "getBoundingClientRect" in H.documentElement
    ? (K.fn.offset = function (a) {
        ...
        var d = c.ownerDocument,
          e = d.documentElement;
        if (!b || !K.contains(e, c))
          return b ? { top: b.top, left: b.left } : { top: 0, left: 0 };
        var f = d.body,
          g = G(d),
          h = e.clientTop || f.clientTop || 0,
          i = e.clientLeft || f.clientLeft || 0,
          j =
            g.pageYOffset || (K.support.boxModel && e.scrollTop) || f.scrollTop,
          k =
            g.pageXOffset ||
            (K.support.boxModel && e.scrollLeft) ||
            f.scrollLeft;
        return { top: b.top + j - h, left: b.left + k - i };
      })
    : (K.fn.offset = function (a) {
        var b = this[0];
        if (a)
        ...
        for (
          var c,
            ...
            g = e.body,
            h = e.defaultView,
            i = h ? h.getComputedStyle(b, null) : b.currentStyle,
            j = b.offsetTop,
            k = b.offsetLeft;
          (b = b.parentNode) &&
          b !== g &&
          b !== f &&
          (!K.support.fixedPosition || "fixed" !== i.position);
          ...
          (c = h ? h.getComputedStyle(b, null) : b.currentStyle),
            ...
            b === d &&
              ...
              !K.support.doesNotAddBorder ||
                (K.support.doesAddBorderForTableAndCells &&
                  wb.test(b.nodeName)) ||
                ((j += parseFloat(c.borderTopWidth) || 0),
            ...
            (i = c);
        return (
          ("relative" !== i.position && "static" !== i.position) ||
    ...
    K.fn.extend({
      position: function () {
        ...
        var a = this[0],
          b = this.offsetParent(),
          c = this.offset(),
          d = xb.test(b[0].nodeName) ? { top: 0, left: 0 } : b.offset();
        return (
      ...
      offsetParent: function () {
        return this.map(function () {
          for (
            ...
            a && !xb.test(a.nodeName) && "static" === K.css(a, "position");
        ...
        return c === b
          ? (e = this[0])
            ? ((f = G(e)),
              f
                ? "pageXOffset" in f
                  ? f[a ? "pageYOffset" : "pageXOffset"]
                  : (K.support.boxModel && f.document.documentElement[d]) ||
                    f.document.body[d]
                : e[d])
            : null
          : this.each(function () {
        ...
        (K.fn[d] = function (a) {
          ...
          if (K.isWindow(e)) {
            var f = e.document.documentElement["client" + c],
              g = e.document.body;
            return (
              ("CSS1Compat" === e.document.compatMode && f) ||
              (g && g["client" + c]) ||
              f
            );
          }
    ...
    (a.flexslider = function (b, c) {
      ...
      a.data(b, "flexslider", d),
        (n = {
          init: function () {
            (d.animating = !1),
              (d.currentSlide = e.startAt),
              (d.animatingTo = d.currentSlide),
              (d.atEnd = 0 === d.currentSlide || d.currentSlide === d.last),
              (d.containerSelector = e.selector.substr(
                0,
                e.selector.search(" ")
              )),
              (d.slides = a(e.selector, d)),
              (d.container = a(d.containerSelector, d)),
              (d.count = d.slides.length),
              (d.syncExists = a(e.sync).length > 0),
              "slide" === e.animation && (e.animation = "swing"),
              (d.prop = i ? "top" : "marginLeft"),
              (d.args = {}),
              (d.manualPause = !1),
              (d.transitions =
                !e.video &&
              ...
              "" !== e.controlsContainer &&
                (d.controlsContainer =
                  a(e.controlsContainer).length > 0 && a(e.controlsContainer)),
              "" !== e.manualControls &&
                (d.manualControls =
                  a(e.manualControls).length > 0 && a(e.manualControls)),
              e.randomize &&
              ...
              m && n.asNav.setup(),
              d.setup("init"),
              e.controlNav && n.controlNav.setup(),
              e.directionNav && n.directionNav.setup(),
              e.keyboard &&
                (1 === a(d.containerSelector).length || e.multipleKeyboard) &&
              ...
              e.slideshow &&
                ...
                e.initDelay > 0 ? setTimeout(d.play, e.initDelay) : d.play()),
              g && e.touch && n.touch(),
              (!l || (l && e.smoothHeight)) &&
                a(window).bind("resize focus", n.resize),
              setTimeout(function () {
                e.start(d);
              }, 200);
          },
            ...
            setup: function () {
              (d.asNav = !0),
                ...
                d.slides.click(function (b) {
                  ...
                  var c = a(this),
                    f = c.index();
                  a(e.asNavFor).data("flexslider").animating ||
                    c.hasClass("active") ||
                    ((d.direction = d.currentItem < f ? "next" : "prev"),
                    d.flexAnimate(f, e.pauseOnAction, !1, !0, !0));
                });
            },
          },
          controlNav: {
            setup: function () {
              d.manualControls
                ? n.controlNav.setupManual()
                : n.controlNav.setupPaging();
            },
            setupPaging: function () {
              var b,
                c =
                  "thumbnails" === e.controlNav
                    ? "control-thumbs"
                    : "control-paging",
                i = 1;
              if (
                ((d.controlNavScaffold = a(
                  '<ol class="' + f + "control-nav " + f + c + '"></ol>'
                )),
                d.pagingCount > 1)
              )
                for (var j = 0; j < d.pagingCount; j++)
                  (b =
                    "thumbnails" === e.controlNav
                      ? '<img src="' + d.slides.eq(j).attr("data-thumb") + '"/>'
                      : "<a>" + i + "</a>"),
              ...
              d.controlsContainer
                ...
                d.controlNavScaffold.delegate("a, img", h, function (b) {
                  ...
                  c.hasClass(f + "active") ||
                    ((d.direction = g > d.currentSlide ? "next" : "prev"),
                    d.flexAnimate(g, e.pauseOnAction));
                }),
                g &&
                  d.controlNavScaffold.delegate(
                    "a",
                    "click touchstart",
                    function (a) {
                      a.preventDefault();
            ...
            setupManual: function () {
              (d.controlNav = d.manualControls),
                n.controlNav.active(),
                d.controlNav.live(h, function (b) {
                  b.preventDefault();
                  var c = a(this),
                    g = d.controlNav.index(c);
                  c.hasClass(f + "active") ||
                ...
                g &&
                  d.controlNav.live("click touchstart", function (a) {
                    a.preventDefault();
                  });
            },
            set: function () {
            ...
            setup: function () {
              ...
              d.controlsContainer
                ...
                d.directionNav.bind(h, function (b) {
                  b.preventDefault();
                  var c = a(this).hasClass(f + "next")
                    ? d.getTarget("next")
                    : d.getTarget("prev");
                  d.flexAnimate(c, e.pauseOnAction);
                }),
                g &&
                  d.directionNav.bind("click touchstart", function (a) {
                    a.preventDefault();
                  });
            },
            update: function () {
          ...
          pausePlay: {
            setup: function () {
              ...
              d.controlsContainer
                ...
                n.pausePlay.update(e.slideshow ? f + "pause" : f + "play"),
                d.pausePlay.bind(h, function (b) {
                  b.preventDefault(),
                    a(this).hasClass(f + "pause")
                      ? (d.pause(), (d.manualPause = !0))
                      : (d.play(), (d.manualPause = !1));
                }),
                g &&
                  d.pausePlay.bind("click touchstart", function (a) {
                    a.preventDefault();
                  });
            },
            update: function (a) {
            ...
            function a(a) {
              d.animating
                ...
                : 1 === a.touches.length &&
                  ...
                  (p = Number(new Date())),
                  (m =
                    k && j && d.animatingTo === d.last
                      ? 0
                      : k && j
                      ? d.limit -
                        (d.itemW + e.itemMargin) * d.move * d.animatingTo
                      : k && d.currentSlide === d.last
                      ? d.limit
                      : k
                      ? (d.itemW + e.itemMargin) * d.move * d.currentSlide
                      : j
                      ? (d.last - d.currentSlide + d.cloneOffset) * n
                      : (d.currentSlide + d.cloneOffset) * n),
                  (g = i ? a.touches[0].pageY : a.touches[0].pageX),
                  (h = i ? a.touches[0].pageX : a.touches[0].pageY),
                  b.addEventListener("touchmove", c, !1),
                  b.addEventListener("touchend", f, !1));
            }
            function c(a) {
              (o = i ? g - a.touches[0].pageY : g - a.touches[0].pageX),
                (!(q = i
                  ? Math.abs(o) < Math.abs(a.touches[0].pageX - h)
                  : Math.abs(o) < Math.abs(a.touches[0].pageY - h)) ||
                  Number(new Date()) - p > 500) &&
                  (a.preventDefault(),
                  !l &&
                    d.transitions &&
                    (e.animationLoop ||
                      (o /=
                        (0 === d.currentSlide && o < 0) ||
                        (d.currentSlide === d.last && o > 0)
                          ? Math.abs(o) / n + 2
                          : 1),
                    d.setProps(m + o, "setTouch")));
            }
            function f(a) {
              if (d.animatingTo === d.currentSlide && !q && null !== o) {
                ...
                d.canAdvance(k) &&
                ((Number(new Date()) - p < 550 && Math.abs(i) > 20) ||
                  Math.abs(i) > n / 2)
                  ? d.flexAnimate(k, e.pauseOnAction)
                  : d.flexAnimate(d.currentSlide, e.pauseOnAction, !0);
              }
              b.removeEventListener("touchmove", c, !1),
                b.removeEventListener("touchend", f, !1),
                (g = null),
                (h = null),
                (o = null),
                (m = null);
        ...
        (d.flexAnimate = function (b, c, g, h, o) {
          if (!d.animating && (d.canAdvance(b) || g) && d.is(":visible")) {
            ...
            if (
              ...
              e.before(d),
              c && d.pause(),
              d.syncExists && !o && n.sync("animate"),
              e.controlNav && n.controlNav.active(),
              k ||
                d.slides
                  .removeClass(f + "active-slide")
                  .eq(b)
              ...
              e.directionNav && n.directionNav.update(),
              b === d.last && (e.end(d), e.animationLoop || d.pause()),
              l)
            )
              d.slides.eq(d.currentSlide).fadeOut(e.animationSpeed, e.easing),
                d.slides.eq(b).fadeIn(e.animationSpeed, e.easing, d.wrapup);
            else {
              var q,
                r,
                s,
                t = i ? d.slides.filter(":first").height() : d.computedW;
              k
                ? ((q = e.itemWidth > d.w ? 2 * e.itemMargin : e.itemMargin),
                ...
                : (r =
                    ...
                    "next" !== d.direction
                      ...
                      : (b + d.cloneOffset) * t),
                d.setProps(r, "", e.animationSpeed),
                d.transitions
                  ? ((e.animationLoop && d.atEnd) ||
        ...
        (d.wrapup = function (a) {
          l ||
            k ||
            (0 === d.currentSlide && d.animatingTo === d.last && e.animationLoop
        ...
        (d.pause = function () {
          clearInterval(d.animatedSlides),
            (d.playing = !1),
            e.pausePlay && n.pausePlay.update("play"),
            d.syncExists && n.sync("pause");
        }),
        (d.play = function () {
          (d.animatedSlides = setInterval(d.animateSlides, e.slideshowSpeed)),
            (d.playing = !0),
            e.pausePlay && n.pausePlay.update("pause"),
            d.syncExists && n.sync("play");
        }),
        ...
        (d.setup = function (b) {
          if (l)
            d.slides.css({
              ...
              "init" === b &&
                d.slides.eq(d.currentSlide).fadeIn(e.animationSpeed, e.easing),
              e.smoothHeight && n.smoothHeight();
          else {
            var c, g;
            "init" === b &&
              ((d.viewport = a('<div class="flex-viewport"></div>')
              ...
              (d.cloneOffset = 0),
              j &&
                ((g = a.makeArray(d.slides).reverse()),
                (d.slides = a(g)),
                d.container.empty().append(d.slides))),
              e.animationLoop &&
                !k &&
                ...
                d.container
                  .append(d.slides.first().clone().addClass("clone"))
                  .prepend(d.slides.last().clone().addClass("clone"))),
              (d.newSlides = a(e.selector, d)),
              (c = j
        ...
        (d.doMath = function () {
          ...
          (d.w = d.width()),
            ...
            k
              ? ((d.itemT = e.itemWidth + b),
                (d.minW = c ? c * d.itemT : d.w),
                (d.maxW = f ? f * d.itemT : d.w),
                (d.itemW =
                  d.minW > d.w
                    ? (d.w - b * c) / c
                    : d.maxW < d.w
                    ...
                    ? d.w
                    : e.itemWidth),
                (d.visible = Math.floor(d.w / (d.itemW + b))),
                (d.move =
                  e.move > 0 && e.move < d.visible ? e.move : d.visible),
                ...
                (d.limit =
                  1 === d.pagingCount
                    ? 0
                    : e.itemWidth > d.w
                    ? (d.itemW + 2 * b) * d.count - d.w - b
                    : (d.itemW + b) * d.count - d.w))
              : ((d.itemW = d.w),
        ...
        (d.update = function (a, b) {
          d.doMath(),
            ...
            e.controlNav &&
              !d.manualControls &&
              (("add" === b && !k) || d.pagingCount > d.controlNav.length
                ...
                : (("remove" === b && !k) ||
                  ...
                  n.controlNav.update("remove", d.last))),
            e.directionNav && n.directionNav.update();
        }),
        (d.addSlide = function (b, c) {
          ...
          (d.count += 1),
            ...
            i && j
              ? void 0 !== c
                ? d.slides.eq(d.count - c).after(f)
                : d.container.prepend(f)
              : void 0 !== c
              ? d.slides.eq(c).before(f)
              : d.container.append(f),
            d.update(c, "add"),
            (d.slides = a(e.selector + ":not(.clone)", d)),
            d.setup(),
            e.added(d);
        }),
  ...
  (function (a) {
      ...
      if (!j[b]) {
        ...
        d.remove(),
          ("none" !== g && "" !== g) ||
            ...
            c.appendChild(e),
            (f && e.createElement) ||
              ((f = (e.contentWindow || e.contentDocument).document),
              f.write(
                (a.support.boxModel ? "<!doctype html>" : "") + "<html><body>"
              ),
              f.close()),
            (d = f.createElement(b)),
    ...
    (a.support.transition =
      "Moz" + o in n ? "Moz" + o : "Webkit" + o in n && "Webkit" + o),
      (a.cssNumber.color = a.cssNumber.backgroundColor = !0),
      (i = {
        linear: "linear",
        swing: "ease-out",
        bounce: p + "0,.35,.5,1.3)",
        ...
        animate: function (b, c, e, f) {
          function g() {
            ...
            for (f in b)
              if (
                ((c = a.camelCase(f)),
                f !== c && ((b[c] = b[f]), delete b[f]),
                (j = a.cssHooks[c]) && "expand" in j)
              ) {
            ...
            for (c in b) {
              if (
                ((e = b[c]),
                a.isArray(e)
                  ? ((t = x.animatedProperties[c] = e[1]), (e = b[c] = e[0]))
                  : (t = x.animatedProperties[c] =
                      (x.specialEasing && x.specialEasing[c]) ||
                      x.easing ||
                      "swing"),
                (s = B && y && x.duration > 0 && c.indexOf("scroll") && i[t]),
                s &&
                  ((u = A[c] || c),
                  (v = u.replace(/([A-Z])/g, "-$1").toLowerCase()),
                  (s = v + " " + x.duration + "ms " + s),
                  (x.transition[c] = { lower: v, real: u }),
                  C.push(s)),
                ("hide" === e && z) || ("show" === e && !z))
              )
              ...
              !y ||
                ...
                "inline" === a.css(this, "display") &&
                  "none" === a.css(this, "float") &&
                  (a.support.inlineBlockNeedsLayout &&
            ...
            for (f in b)
              (g = new a.fx(this, x, f)),
                ...
                k.test(e)
                  ? ((r =
                      a._data(this, "toggle" + f) ||
                      ("toggle" === e ? (z ? "show" : "hide") : 0)),
                    r
                      ? (a._data(
                          this,
                          "toggle" + f,
                  ...
                  : ((n = l.exec(e)),
                    ...
                    n
                      ? ((p = parseFloat(n[2])),
                        (q = n[3] || (a.cssNumber[f] ? "" : "px")),
                        "px" !== q &&
                          "opacity" !== f &&
                          (a.style(this, f, (p || 1) + q),
                          (o = ((p || 1) / g.cur()) * o),
                          a.style(this, f, o + q)),
                        n[1] && (p = ("-=" === n[1] ? -1 : 1) * p + o),
                        g.custom(o, p, q))
            ...
            if (B && C.length) {
              (s = this.style[B]),
                (w = window.getComputedStyle(this)),
                (this.style[B] =
                  C.join() + (s && s.indexOf("none") ? "," + s : ""));
              for (f in x.transition)
                w[f], a.style.apply(null, x.transition[f].styleToSet);
            }
            return !0;
          }
          var h = a.speed(c, e, f);
          return a.isEmptyObject(b)
            ? this.each(h.complete, [!1])
            : ((b = a.extend({}, b)),
              !1 === h.queue ? this.each(g) : this.queue(h.queue, g));
        },
        stop: function (b, c, d) {
          return (
      ...
      a.extend(a.fx.prototype, {
        ...
        custom: function (c, d, e) {
          ...
          (this.startTime = h || b()),
            ...
            (this.pos = this.state = 0),
            (this.unit = e || this.unit || (a.cssNumber[l] ? "" : "px")),
            (f.queue = this.options.queue),
            (f.elem = this.elem),
            (f.saveState = function () {
              void 0 === a._data(i.elem, "fxshow" + i.prop) &&
                (i.options.hide
                  ? a._data(i.elem, "fxshow" + i.prop, i.start)
                  : i.options.show &&
                    a._data(i.elem, "fxshow" + i.prop, i.end));
            }),
            (f.transition = k[l])
              ? (a.timers.push(f),
                "transform" != l && (i.elem.style[k[l].real] = c + i.unit),
                a.fx.step[l] && (d = Math.max(0, d)),
                (k[l].styleToSet = [i.elem, l, d + i.unit]),
                (k[l].timeout = setTimeout(function () {
                  a.timers.splice(a.timers.indexOf(f), 1), i.step(!0);
                }, i.options.duration + 30)))
              : f() &&
                a.timers.push(f) &&
                !g &&
                (g = setInterval(j.tick, j.interval));
        },
        step: function (c) {
          var d,
            e,
          ...
          if (l || c || m) {
            l
              ? (clearTimeout(l.timeout),
                c || m || (this.elem.style[l.real] = a.css(this.elem, l.real)))
              : ((this.now = this.end),
                (this.pos = this.state = 1),
                this.update()),
              (k.animatedProperties[this.prop] = !0);
            for (d in k.animatedProperties)
              !0 !== k.animatedProperties[d] && (i = !1);
            if (i) {
              if (
                (null == k.overflow ||
                  a.support.shrinkWrapBlocks ||
                  a.each(["", "X", "Y"], function (a, b) {
                ...
                l = "," + j.style[n];
                for (d in k.transition)
                  l = l.split(k.transition[d].lower).join("_");
                (l = l.replace(/, ?_[^,]*/g, "").substr(1)),
                  (j.style[n] = l || "none"),
                  !l && (j.style[n] = l);
              }
              if (k.hide || k.show)
                for (d in k.animatedProperties)
                  (c || m) && a.style(j, d, k.orig[d]),
                    a.removeData(j, "fxshow" + d, !0),
                    a.removeData(j, "toggle" + d, !0);
          ...
          return (
            k.duration == 1 / 0
              ? (this.now = g)
              : ((e = g - this.startTime),
                (this.state = e / k.duration),
                (this.pos = a.easing[k.animatedProperties[this.prop]](
                  this.state,
                  e,
                  0,
                  1,
      ...
      a.extend(a.fx, {
        tick: function () {
          for (var b, c = a.timers, d = 0; d < c.length; d++)
            (b = c[d]), b.transition || b() || c[d] !== b || c.splice(d--, 1);
          c.length || a.fx.stop();
        },
      });
  })(jQuery),
  (function (a) {
      ...
      createPath: function (a) {
        ...
        if ("svg" == this.mode)
          ...
          (b = this.createVmlNode("shape")),
            ...
            (b.fillcolor = e.defaultFillColor),
            (b.stroked = !1),
            (b.path = d.pathSvgToVml(a.path));
      ...
      (d.pathSvgToVml = function (a) {
        ...
        return a
          .replace(
            ...
            function (a, f, g, h) {
              (g = g.replace(/(\d)-/g, "$1,-").replace(/\s+/g, ",").split(",")),
                g[0] || g.shift();
    ...
    var e = function (b) {
      ...
      (this.container = b.container),
        (this.defaultWidth = g.width),
        (this.defaultHeight = g.height),
        (this.color = b.color),
        (this.hoverColor = b.hoverColor),
        this.setBackgroundColor(b.backgroundColor),
        (this.width = b.container.width()),
        (this.height = b.container.height()),
        this.resize(),
        jQuery(window).resize(function () {
          (c.width = b.container.width()),
            (c.height = b.container.height()),
            c.resize(),
            c.canvas.setSize(c.width, c.height),
            c.applyTransform();
        }),
        (this.canvas = new d(this.width, this.height, b)),
        b.container.append(this.canvas.canvas),
        this.makeDraggable(),
      ...
      for (var h in g.pathes) {
        var i = this.canvas.createPath({ path: g.pathes[h].path });
        i.setFill(this.color),
          (i.id = "jqvmap" + c.index + "_" + h),
          (c.countries[h] = i),
          jQuery(this.rootGroup).append(i),
          i.setAttribute("class", "jqvmap-region"),
          null !== b.selectedRegion &&
            h.toLowerCase() == b.selectedRegion.toLowerCase() &&
            i.setFill(b.selectedColor);
      }
      jQuery(b.container).delegate(
        ...
        function (d) {
          ...
          "mouseover" == d.type
            ? (jQuery(b.container).trigger(i, [f, g.pathes[f].name]),
              i.isDefaultPrevented() ||
                (b.hoverOpacity
                  ? e.setOpacity(b.hoverOpacity)
                  : b.hoverColor &&
                    ((e.currentFillColor = e.getFill() + ""),
                    e.setFill(b.hoverColor))),
              b.showTooltip &&
                (c.label.text(g.pathes[f].name),
                jQuery(b.container).trigger(h, [c.label, f]),
            ...
            : (e.setOpacity(1),
              ...
              c.label.hide(),
              jQuery(b.container).trigger("regionMouseOut.jqvmap", [
                f,
                g.pathes[f].name,
              ]));
        }
        ...
        jQuery(b.container).delegate(
          ...
          function (d) {
            ...
            void 0 !==
              ...
              b.iPad &&
              (console.log(b.isIpad),
              (f.currentFillColor = b.selectedColor),
              f.setFill(b.selectedColor),
              a("#states_list").find("ul li").removeClass("active"),
              a("#states_list")
                .find("#" + h)
                .addClass("active"),
              setTimeout(function () {
                (f.currentFillColor = "2B2B2B"),
                  f.setFill("#2B2B2B"),
                  a("#states_list").find("ul li").removeClass("active");
              }, 1e3));
          }
        ...
        b.showTooltip &&
          b.container.mousemove(function (a) {
            c.label.is(":visible") &&
              c.label.css({
        ...
        this.setColors(b.colors),
        this.canvas.canvas.appendChild(this.rootGroup),
        this.applyTransform(),
        (this.colorScale = new f(
          b.scaleColors,
          b.normalizeFunction,
          b.valueMin,
          b.valueMax
        )),
        b.values && ((this.values = b.values), this.setValues(b.values)),
    ...
    (e.prototype = {
      ...
      setValues: function (a) {
        var b,
          ...
          d = Number.MAX_VALUE;
        for (var e in a)
          (b = parseFloat(a[e])), b > c && (c = a[e]), b && b < d && (d = b);
        this.colorScale.setMin(d), this.colorScale.setMax(c);
        var f = {};
        for (e in a)
          (b = parseFloat(a[e])),
            (f[e] = b ? this.colorScale.getColor(b) : this.color);
          ...
          if (a.zoomCurStep < a.zoomMaxStep) {
            ...
            (a.transX -=
              ...
              jQuery("#zoomSlider").css(
                "top",
                parseInt(jQuery("#zoomSlider").css("top"), 10) - b
              );
          }
        }),
    ...
    if (!location.hash && a.addEventListener) {
      ...
      var c = 1,
        d = function () {
          return (
            a.pageYOffset ||
            ("CSS1Compat" === b.compatMode && b.documentElement.scrollTop) ||
            b.body.scrollTop ||
            0
          );
        },
        e = setInterval(function () {
          b.body &&
            (clearInterval(e), (c = d()), a.scrollTo(0, 1 === c ? 0 : 1));
        }, 15);
      a.addEventListener(
        "load",
        function () {
  ...
  (function (a) {
    ...
    function b(a) {
      ...
      a || (a = {}),
        "number" == typeof a && (a = { frameRate: a }),
        null != a.useNative || (a.useNative = !0),
        (this.options = a),
        (this.frameRate = a.frameRate || b.FRAME_RATE),
    ...
    !(function () {
      ...
      for (
        c = f.requestAnimationFrame,
          d = f.cancelAnimationFrame || f.cancelRequestAnimationFrame,
          e = 0;
        e < g.length && !c;
        e++
      )
        (c = f[g[e] + "RequestAnimationFrame"]),
          (d =
            f[g[e] + "CancelAnimationFrame"] ||
            f[g[e] + "CancelRequestAnimationFrame"]);
      c &&
        c(function () {
          b.hasNative = !0;
        });
      ...
      (b.perfNow = function () {
        return a.performance && a.performance.now
          ? a.performance.now()
          : b.now() - b.navigationStart;
      }),
      (b.hasNative = !1),
      (b.prototype.request = function (d) {
        var e,
          f = this;
        if (
          (++this._tickCounter,
          b.hasNative && f.options.useNative && !this._isCustomFrameRate)
        )
          return c(d);
        if (!d) throw new TypeError("Not enough arguments");
        return (
          null == this._timeoutId &&
            ((e = this._frameLength + this._lastTickTime - b.now()),
            e < 0 && (e = 0),
            (this._timeoutId = a.setTimeout(function () {
              var a;
              (f._lastTickTime = b.now()),
                (f._timeoutId = null),
                ++f._tickCounter;
              for (a in f._callbacks)
                f._callbacks[a] &&
                  (b.hasNative && f.options.useNative
                    ? c(f._callbacks[a])
                    : f._callbacks[a](b.perfNow()),
                  delete f._callbacks[a]);
            }, e))),
          (this._callbacks[this._tickCounter] = d),
          this._tickCounter
        );
      }),
      (b.prototype.cancel = function (a) {
        b.hasNative && this.options.useNative && d(a),
...
var DGA = {
  breakpoints: { fadeNavbar: 0, fixNavbar: 0 },
  browserDimensions: { height: 0, width: 0 },
  ...
  bindHandlers: function () {
    ...
    return (
      ...
      e.$html$body.on(
        ...
        function (a) {
          (a.which > 0 || "mousedown" == a.type || "mousewheel" == a.type) &&
            e.$html$body.stop();
        }
      ),
      ...
      e.$about.nav.on("click", "li", function () {
        (a = parseInt($(this).attr("data-id"), 10)),
          e.changeAboutModule(a, this);
      }),
      e.$about.states_list.on("hover", "li", function (a) {
        (c = {}),
          ...
          "mouseenter" == a.type
            ? (c[d] = "#963947")
            : "mouseleave" == a.type && (c[d] = "#2B2B2B"),
          $("#vmap").vectorMap("set", "colors", c);
      }),
  ...
  loadFlexsliders: function () {
    var a = this,
      b = {
        ...
        start: function (a) {
          $("#thumbnails").on("click", "ul li", function () {
            $("#thumbnails")
              .addClass("active")
              .find('ul li[data-id="' + a.currentSlide + '"]')
              .removeClass("active");
      ...
      c = {
        ...
        after: function (b) {
          a.$home
            .find('.slides li[data-id="' + b.currentSlide + '"] .content')
            .delay(250)
            .animate({ opacity: 1 }, 750, function () {
              $(this).find("h4").animate({ opacity: 1 }, 750);
            });
        },
        before: function (b) {
          a.$home
            ...
            .animate({ opacity: 0 }, 100, function () {
              $(this).find("h4").animate({ opacity: 0 }, 100);
            });
        },
        start: function () {
          a.$home
            .find('.slides li[data-id="0"] .content')
            .delay(750)
            .animate({ opacity: 1 }, 750, function () {
              $(this).find("h4").animate({ opacity: 1 }, 750);
            });
      ...
      d = {
        ...
        start: function (b) {
          ...
          $("#services .tiles").on("click", ".tile", function () {
            (c = parseInt($(this).attr("data-id"), 10)),
              d &&
                (e(),
            ...
            $("#navigation").on("click", ".arrow", function () {
              (c = b.getTarget($(this).attr("data-id"))),
                d && e(),
                b.flexAnimate(c);
            });
        },
    ...
    return (
      ...
      a.iPad
        ? ((c.animation = "slide"), $(".hover").removeClass("hover"))
        : $("#ipad_spacer").hide(),
      a.browserDimensions.width > 767 &&
        ($("#bios").flexslider(b),
        $("#home").flexslider(c),
        $("#services #list").flexslider(d),
        $("#services #counter .flexslider").flexslider(e)),
      a
    );
  },
  ...
  changeAboutModule: function (a, b) {
    ...
    return (
      ...
      1 === a &&
        (c.$about.modules[1].find("#bios").flexslider(0),
        $("#thumbnails")
          .removeClass("active")
          .find("ul li")
          .removeClass("active")),
      a !== c.currentAboutModule &&
        !c.isAboutAnimating &&
        ((c.isAboutAnimating = !0),
        $("#about_menu li").removeClass("active"),
        $(b).addClass("active"),
        0 === c.currentAboutModule
          ? c.$about.modules[0].animate({ opacity: 0 }, e, function () {
              c.$about.banner.slideDown(d, function () {
                c.$about.modules[a].fadeIn(e, function () {
                  2 === a
                    ? c.$about.states_list.slideDown(e, function () {
          ...
          : (2 === c.currentAboutModule && c.$about.states_list.slideUp(e),
            0 === a
              ? c.$about.modules[c.currentAboutModule].fadeOut(e, function () {
                  c.$about.banner.slideUp(d, function () {
                    c.$about.modules[a].animate({ opacity: 1 }, e, function () {
                      c.isAboutAnimating = !1;
                    });
                  });
                })
  ...
  changeSection: function (a) {
    var b = this;
    return (
      (0 !== b.currentSection || -1 !== a) &&
      ((b.currentSection += a), b.scrollPage(b.sections[DGA.currentSection]), b)
    );
  },
  loadGoogleMaps: function () {
    var a = new google.maps.LatLng(33.054901, -117.288064),
      b = {
        ...
        styles: [
          {
            featureType: "water",
            stylers: [{ color: "#1C1C1C" }, { visibility: "on" }],
          },
          { featureType: "landscape", stylers: [{ color: "#282828" }] },
          {
            featureType: "administrative",
            elementType: "geometry.stroke",
            stylers: [{ color: "#4a4a4a" }, { weight: 0.4 }],
          },
          ...
          },
          {
            ...
            stylers: [{ color: "#282828" }, { weight: 4 }],
          },
          {
            featureType: "road",
            elementType: "labels.text",
            stylers: [{ color: "#eaeaea" }, { weight: 0.5 }],
          },
          {
            elementType: "labels.text",
            stylers: [{ color: "#dbdbdb" }, { weight: 0.4 }],
          },
          {
            featureType: "administrative",
            elementType: "labels.text",
          ...
          },
          {
            ...
            elementType: "labels",
            stylers: [{ color: "#636363" }, { visibility: "off" }],
          },
          {
  ...
  loadImages: function () {
    ...
    return (
      Modernizr.svg
        ? b.loadVectorMap()
        : ($("#load_map_png").attr("src", "static/img/Yatenga_departments.png"),
          b.$about.states_list.unbind("hover"),
          (c = ".png")),
      b.browserDimensions.width > 767
        ? $(".load-jpg").each(function () {
            $(this).attr(
              "src",
              "static/img/" + $(this).attr("data-id") + ".jpg"
            );
          })
  ...
  resizeElements: function () {
    var a = 60;
    if (
      (this.browserDimensions.height > 800 && (a = 106),
      $("#home").css(
        "height",
        this._convertIntToPx(this.browserDimensions.height)
      ),
      $("#map_canvas").css(
        "height",
        this._convertIntToPx(0.4 * this.browserDimensions.height)
      ),
      $("section").css(
        "min-height",
        this._convertIntToPx(this.browserDimensions.height - a)
      ),
      ...
      if (
        ...
        this.browserDimensions.height < b)
      ) {
        var c = -(b - this.browserDimensions.height) / 2;
        $(".slides img")
          .css("margin-top", this._convertIntToPx(c))
          .css("margin-left", 0);
      }
    } else {
      ...
      if (
        ...
        this.browserDimensions.width < d)
      ) {
        var e = -(d - this.browserDimensions.width) / 2;
        $(".slides img")
          .css("margin-left", this._convertIntToPx(e))
          .css("margin-top", 0);
      }
    }
    return (
      this.browserDimensions.width > 767
        ? (this.render(),
          this.$window.off("scroll").on("scroll", $.proxy(this.scroll, this)))
        : (this.$nav.list_links.removeClass("active"),
          this.$nav.navbar.removeClass(
            "navbar-fixed-top navbar-absolute-bottom"
          ),
          (this.scrollOffset = 0),
          this.$window.off()),
      this
  ...
  setBrowserOffsets: function () {
    ...
    for (a = this.sections.length; a--; )
      (this.offsets[this.sections[a]] = $("#" + this.sections[a]).offset().top),
        a > 0 &&
          (this.offsets[this.sections[a] + "_detect"] =
            this.offsets[this.sections[a]] - 200);
    return this;
  },
  ...
  setSection: function () {
    return (
      ...
      this.scrollTop > this.offsets.contact_detect
        ? ((this.currentSection = 4),
          $("#left, #right, #down").removeClass("active"),
          $("#up").addClass("active"))
        : this.scrollTop > this.offsets.services_detect
        ? ((this.currentSection = 3),
          $("#left, #right, #down, #up").addClass("active"))
        : this.scrollTop > this.offsets.process_detect
        ? ((this.currentSection = 2),
          $("#left, #right").removeClass("active"),
          $("#down, #up").addClass("active"))
        : this.scrollTop > this.offsets.about_detect
  ...
  render: function () {
    ...
    return (
      ...
      this.scrollTop > this.breakpoints.fixNavbar
        ? this.$nav.navbar.addClass("navbar-fixed-top").css("top", 0)
        : this.$nav.navbar
            .removeClass("navbar-fixed-top")
            .css("top", this._convertIntToPx(this.breakpoints.fixNavbar)),
      this.scrollTop > this.breakpoints.fadeNavbar
  ...
  scrollPage: function (a) {
    var b,
      c = DGA.offsets[a] - DGA.scrollOffset,
      d = Math.abs(DGA.currentSection - $.inArray(a, DGA.sections)),
      e = 500;
    d > 1 && (e += (e * (d - 1)) / d),
      DGA.$html$body
        .stop()
        .animate({ scrollTop: c }, e, "easeInOutQuad", function () {
          DGA.iPad &&
        ...
        this.each(function () {
          function b(b) {
            ...
            switch (c) {
              ...
              case 39:
                b.preventDefault(),
                  0 === DGA.currentSection
                    ? DGA.$home.flexslider("next")
                    : 1 === DGA.currentSection
                    ? ((d =
                        DGA.currentAboutModule < 2
                          ? DGA.currentAboutModule + 1
                          : 0),
                      DGA.$about.nav.find('li[data-id="' + d + '"]').click())
                    : 3 === DGA.currentSection &&
                      ("none" === a("#services .banner").css("display") &&
              ...
              case 40:
                b.preventDefault(),
                  DGA.currentSection < 4 && DGA.changeSection(1);
                break;
              case 37:
                b.preventDefault(),
                  0 === DGA.currentSection
